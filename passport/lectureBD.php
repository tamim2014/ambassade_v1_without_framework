...
<head>
	 ...
	 <script src="js/capture_items_passeport.js"></script>    <!--    <script src="js/acteOutSlide.js"></script> -->
	   ...
	   // Cette fonction répond au bouton"Zoom" ou au bouton "Affiche plein écran"
        ...
        {    
           //window.open("http://google.fr/", "Autrepage", "toolbar=1, location=1, directories=1, status=1, scrollbars=1, resizable=1, copyhistory=1");
		     window.open("afficherdanspop_listePasseport.php?pr=+str", 'Popup', 'scrollbars=1, Menubar=1, resizable=1,height=409,width=918 ,  top=258, left=175 '); 
			 return false;          
		}
	</script>
</head>
...
<!-- ARRIERE PLAN :  -->
<?php include("inc/lecture/lectureBD_background_fiche_export.php"); ?>
