...
<article>
    ...
    <form action="index.php"   method="post">
		...
		<fieldset id="coordonnees">		
			<input type="text" name="nom" size="30" placeholder=" Nom :" />
			<input type="text" name="prenom" size="30" placeholder=" Prenom :" />
			<input type="text" name="login" size="30" placeholder=" Login :" />
			<input type="text" name="password" size="30" placeholder=" Password :" />	
			<input type="text" name="tel" size="30"  placeholder=" Télephone :" />
			
			<input type="date" name="date_naissance" size="30"  placeholder=" Date de naissance :" />		
			<select name="ville">
