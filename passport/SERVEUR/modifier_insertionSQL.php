...
$sql = "UPDATE passport 
        ...
        WHERE idPassport=?";
$q = $conn->prepare($sql);
$accent=$q->execute(array($nom_demandeur,$prenom_demandeur,$montant,$observation,$lot,$date_export,$dossier_expedie,$date_expedie,$passeport_arrive,$date_arrive,$passeport_livre,$date_livraison,$nom_recepteur,$n));
