...
$requete='SELECT * FROM caisse WHERE mois="'.$pr.'"';// WHERE (mois="'.$pr.'")  AND (mois LIKE "'.$pr.'%")';
...
//3.1 On construit une table d'affichage
				...
				while($ligne = $reponse->fetch()){// en utlisant FOREACH ça marche pas .j'sais pas pourquoi
				 $table.='<tr><td>'.$ligne["date"].'</td><td>'.$ligne["piece"].'</td><td>'.$ligne["imputation"].'</td><td style="border-radius:0px;">'.$ligne["libelle"].'</td><td style="border-radius:0px;"></td><td style="border-radius:0px;"></td><td style="border-radius:0px;"></td><td>'.$ligne["debit"].'</td><td>'.$ligne["credit"].'</td><td></td></tr>';               
			     ...
			     $table.='<tr><td style="border-radius:0px;">TOTAL :</td><td style="border-radius:0px;"></td><td style="border-radius:0px;"></td><td colspan="4" style="border-radius:0px;"></td><td style="border-radius:0px;">'.$debit.' €</td><td style="border-radius:0px;">'.$credit.' €</td></tr>';
				 ...
				 $table.='<tr><td style="border-radius:0px;"></td><td style="border-radius:0px;"></td><td style="border-radius:0px;"></td><td colspan="4" style="border-radius:0px;"></td><td style="border-radius:0px;"></td><td style="border-radius:0px;">'.$_SESSION["mois"].'</td><td style="color:green; text-size:18px;">'.$solde.' €</td></tr>';
