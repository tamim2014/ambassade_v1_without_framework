...
//lectureBD.php
		...
		function captureSousMenu(str){ // str represente la préfecture selectionnée dans le sous-menu
            if (str == "") { 
                ...
                //Connection[au serveur php] et Paramèttrage[str est la prefecture choisie]  
				xmlhttp.open("GET","SERVEUR/lectureBD_afficherListe_legalisation.php?pr="+str,true); // On DEVRAI reutileSER le mm script car c'est le mm traitement MAIS LA VARIABLE SESSION se la ramene et m'emmerde!
                // Envoi
				xmlhttp.send(); 
