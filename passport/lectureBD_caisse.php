...
<head>
     ...
     <title> Affichage caisse: ambassade des Comores à Paris</title>
     <link rel="icon" type="image/png" href="../img/ambassade.png" /> 
	 <script src="js/jquery.js"></script>
	 <!-- Traitement menu de gauche(annee) et son sous-menu(mois) -->
	 <script src="js/capture_items_caisse.js"></script>    <!--    <script src="js/acteOutSlide.js"></script> -->
	   ...
	   // Cette fonction répond au bouton"Zoom" ou au bouton "Affiche plein écran"
        ...
        {    
           //window.open("http://google.fr/", "Autrepage", "toolbar=1, location=1, directories=1, status=1, scrollbars=1, resizable=1, copyhistory=1");
		     window.open("afficherdanspop_listeCaisse.php?pr=+str", 'Popup', 'scrollbars=1, Menubar=1, resizable=1,height=409,width=918 ,  top=258, left=175 '); 
			 return false;          
		}
	</script>
	...
	<ul class="navigation" style=" position:fixed; top:10px; right:-39px; margin-right:0px; padding-right:0px; width:15.7%;" >	
		...
		<li class="toggleSubMenu"><span>Caisse</span>
			  <ul class="subMenu" style="color: #fff;" >
				...
				<li><a href="#" title="" style="color:#fff;">Journal de caisse</a></li>
			  </ul>
		</li>
...
<!-- ARRIERE PLAN :  -->
<?php include("inc/lecture/lectureBD_background_journal_caisse.php"); ?>
...
<table class="tablegauche" > <caption  style="caption-side:top;  z-index:4;"> <font color="#FFFFFF"><h3> UNION DES COMORES  </h3><h6> Unit&eacute;-Solidarit&eacute;-D&eacute;veloppement  </h6><h4> AMBASSADE DES COMORES  </h4></font><img src="img/armoirie.png"   /></caption>
	 <tr><td id="capturemenu">
	     
	     <?php include("inc/lecture/menugauche_caisse.php"); ?> 
...
<table  class="tabledroiteresultat" ><caption style="caption-side:top"> <font color="#FFFFFF"><h3> FICHE EXPORT  </h3></caption>
 ...
 <?php include("inc/lecture/sousmenu_caisse.php"); ?>
...
<div class="mnayvawo"  >  <button    class="boutoyahemnayivawo" style="font-size: 15px; font-style: italic; font-family: \"Times New Roman\", Georgia, Serif;  "  > Période : <span id="wilaya_" style="color:#000066;  font-size: 17px; font-style: italic; font-family: \"Times New Roman\", Georgia, Serif;" > <?php  echo  $s; ?></span> </button> </div>
