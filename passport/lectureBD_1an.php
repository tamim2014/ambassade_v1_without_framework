		 ...
		 <div id="yivawo"  style="left:13px;   box-shadow: 1px 1px 0px 0px #cdbe9f; " >
			...
			<?php
			   //1.Connexion
				...
				//2.Requête 
				$requete='SELECT * FROM passport WHERE   YEAR(date_livraison) = YEAR(NOW())  ORDER BY date_livraison DESC';
				...
				$reponse3 = $conn->query($requete3) ;//Stockage de la requête dans une variable tampon
