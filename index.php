...
<head>
 ...
 <link rel="icon" type="image/bmp" href="img/ambassade.bmp" /> 
...
<body>
<!-- ARRIERE-PLAN - classeur vert -->

<!-- <table class="closeLowerMargin "  style="background-color:#1D702D;  top:-360px; z-index:2;  border-radius:20px;"><tr><td>   </td></tr></table>  -->
<table class="closeLowerMargin "  style="background-color:#1D702D;  top:10px; height:248px; z-index:2;  border-radius:0px 0px 20px 20px ;"><tr><td>   </td></tr></table> 
