...
//lectureBD.php
		 ...
		 $(document).ready(function(){
					...
					// Les prefecture de la grande comores	
					...
					// Les prefecture de moheli					
					$("ul li.sousmenu2  ul.panel3 li a").click(function() {  
							   captureSousMenu(this.textContent);
					}); 
					//Les prefectures d'anjouan					
		...
		function captureSousMenu(str){ // str represente la préfecture selectionnée dans le sous-menu
            if (str == "") { 
                ...
                //Connection[au serveur php] et Paramèttrage[str est la prefecture choisie]  
				xmlhttp.open("GET","SERVEUR/lectureBD_afficherListe.php?pr="+str,true); // On DEVRAI reutileSER le mm script car c'est le mm traitement MAIS LA VARIABLE SESSION se la ramene et m'emmerde!
                // Envoi
				xmlhttp.send(); 
